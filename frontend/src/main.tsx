  ...
  createRoutesFromElements(
    <Route path='/' element={<App />}>
      ...
      <Route path='' element={<PrivateRoute />}>
        <Route path='/fact/user/:id' element={<ProfileScreen />} />
        <Route path='/fact/create' element={<CreateFactScreen />} />
        <Route path='/fact/:id/edit' element={<EditFactScreen />} />
      </Route>

      {/* Admin-Only Routes */}
      <Route path='' element={<AdminRoute />}>
        <Route path='/admin/factlist' element={<FactListScreen />} />
        <Route path='/admin/userlist' element={<UserListScreen />} />
        <Route path='/admin/factlist/page/:pageNumber' element={<FactListScreen />} />
