...
const ProfileScreen = () => {
	...
	const { data: userFacts, isLoading: loadingUserFacts, error: userFactsError, refetch } = useGetAllFactsByUserIdQuery({ id: userInfo._id, pageNumber });
			...
			{loadingUserFacts ? (
				...
				<>
					...
					{userFacts && userFacts.pages && userFacts.page && (
						<Paginate
							pages={userFacts.pages}
							currentPage={userFacts.page}
							isAdmin={true}
						/>
					)}
