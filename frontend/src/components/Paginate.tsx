  ...
  return (
    <>
      {pages > 1 && (
        <Pagination size='sm'>
          <LinkContainer
            to={!isAdmin ? `/page/1` : facts ? `/admin/factlist/page/1` : `/admin/userlist/page/1`}
          >
            <Pagination.First />
          </LinkContainer>
          <LinkContainer
            to={
              !isAdmin
                ...
                : facts
                  ? `/admin/factlist/page/${Math.max(1, currentPage - 1)}`
                  : `/admin/userlist/page/${Math.max(1, currentPage - 1)}`
            }
          >
            <Pagination.Prev />
          </LinkContainer>
          ...
          <LinkContainer
            to={
              !isAdmin
                ...
                : facts
                  ? `/admin/factlist/page/${Math.min(pages, currentPage + 1)}`
                  : `/admin/userlist/page/${Math.min(pages, currentPage + 1)}`
            }
          >
            <Pagination.Next />
          </LinkContainer>
